...
//    console.log("principalId", principalId);
	...
	$("#userProfileImageInput").on("change", (e) => {
        ...
        $.ajax({
            ...
            data: formData,
            contentType: false, // 필수 : x-www-form-urlencoded로 파싱되는 것을 방지(x-www-form-urlencoded로는 사진 전송을 할 수 없음)
            processData: false, // 필수 : contentType을 false로 줬을 때 QueryString으로 자동 설정됨, 그것을 해제
